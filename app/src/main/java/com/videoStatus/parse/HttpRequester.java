...
import com.videoStatus.utills.AndyUtils;
import com.videoStatus.utills.AppLog;
                ...
                if (!isGetMethod) {
                    ...
                    for (String key : map.keySet()) {
                        ...
                        if(!key.equalsIgnoreCase("offset")) {
                            ...
                            Log.d(TAG, "doInBackground:dhara ");
                            nameValuePairs.add(new BasicNameValuePair("TXType",Integer.toString(1)));
                        }
                    }
