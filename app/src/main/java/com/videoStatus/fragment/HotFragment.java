...
/**
 * Created by Shabana Khatri on 12-07-2018.
 */
...
public class HotFragment extends Fragment {
    ...
    private HotFragment.RecyclerAdapter photoListAdapter;


    private FragmentVideosBinding binding;
    private View mrootView;
    //    private SwipeRefreshLayout swipeRefreshLayout;
    private static HotFragment.RecyclerAdapter recylerAdapter;
...
//        mRecyclerView.addOnScrollListener(mOnScrollListener);
    ...
    private void loadMore(final ArrayList<DataItem> arrayListMain, boolean firstTime) {
        if (firstTime) {
            recylerAdapter = new HotFragment.RecyclerAdapter(mRecyclerView, getActivity(), arrayListMain);
            ...
            public void run() {
                if (!recyclerView.isComputingLayout()) {
                    ...
                    try {
                        Thread.sleep(10);
                        if (ConstantManager.IS_WIFI) {
                            ((HotFragment.RecyclerAdapter.ItemViewHolder) recyclerView.findViewHolderForLayoutPosition(i)).itemView.performClick();
                        }
    ...
    public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            if (viewType == 11) {
                ...
                return new HotFragment.RecyclerAdapter.ItemViewHolder(view);
            } else if (viewType == 12) {
                view = LayoutInflater.from(parent.getContext()).inflate(R.layout.add_layout, parent, false);
                return new HotFragment.RecyclerAdapter.ViewHolder2(view);
            } else if (viewType == VIEW_TYPE_LOADING) {
                view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_loading, parent, false);
                return new HotFragment.RecyclerAdapter.LoadingViewHolder(view);
            }
            return null;
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
            ...
            if (holder.getItemViewType() == 11) {
                final HotFragment.RecyclerAdapter.ItemViewHolder itemViewHolder = (HotFragment.RecyclerAdapter.ItemViewHolder) holder;
            ...
            } else if (holder instanceof HotFragment.RecyclerAdapter.LoadingViewHolder) {

                HotFragment.RecyclerAdapter.LoadingViewHolder loadingViewHolder = (HotFragment.RecyclerAdapter.LoadingViewHolder) holder;
                ...
                HotFragment.RecyclerAdapter.ViewHolder2 viewHolder2 = (HotFragment.RecyclerAdapter.ViewHolder2) holder;
