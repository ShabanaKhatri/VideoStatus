package com.videoStatus.videomanage.ui;
...
public abstract class MediaPlayerWrapper
    ...
    public void onPrepared(MediaPlayer mp) {
        ...
        Log.d(TAG, "onPrepared:HappppyHere");
        start();
    }
    ...
    public void start() {
        ...
        synchronized (mState) {
            ...
            try{
//                if(ConstantManager.arrayList.get(ConstantManager.happyPosition).isPlayVideo()) {

                if(mMediaPlayer!=null) {
                    if (ConstantManager.mEndTimeTextView != null && ConstantManager.mCurrentTimeTextView != null) {
                        if (!ConstantManager.mEndTimeTextView.getText().toString().trim().equalsIgnoreCase(ConstantManager.mCurrentTimeTextView.getText().toString().trim())) {
                            mMediaPlayer.seekTo((int) ConstantManager.arrayList.get(ConstantManager.happyPosition).getSeek_position());
                        } else {
