...
import com.videoStatus.videomanage.Config;
import com.videoStatus.videomanage.MessagesHandlerThread;
import com.videoStatus.videomanage.PlayerMessageState;
import com.videoStatus.videomanage.SetNewViewForPlayback;
import com.videoStatus.videomanage.meta.MetaData;
import com.videoStatus.videomanage.playermessages.ClearPlayerInstance;
import com.videoStatus.videomanage.playermessages.CreateNewPlayerInstance;
import com.videoStatus.videomanage.playermessages.Prepare;
import com.videoStatus.videomanage.playermessages.Release;
import com.videoStatus.videomanage.playermessages.Reset;
import com.videoStatus.videomanage.playermessages.SetAssetsDataSourceMessage;
import com.videoStatus.videomanage.playermessages.SetUrlDataSourceMessage;
import com.videoStatus.videomanage.playermessages.Stop;
import com.videoStatus.videomanage.ui.MediaPlayerWrapper;
import com.videoStatus.videomanage.ui.VideoPlayerView;
import com.videoStatus.videomanage.utils.Logger;
...
public class SingleVideoPlayerManager implements VideoPlayerManager<MetaData>, VideoPlayerManagerCallback, MediaPlayerWrapper.MainThreadMediaPlayerListener {
    ...
    public void playNewVideo(MetaData currentItemMetaData, VideoPlayerView videoPlayerView, String videoUrl) {
        ...
        try {
            boolean currentPlayerIsActive = currentItemMetaData.isMorePlayView() && mCurrentPlayer == videoPlayerView;
...
//
//            //play the same url video
//            if(isAlreadyPlayingTheFile){
//
//                // The same VideoPlayerView play the same URL
...
//        }
     ...
     * 1. Stop queue processing to have consistent state of queue when posting new messages
     * 2. Check if current player is active.
     * 3. If it is active and already playing current video we pause it or start again
     * 4. If not active then start new playback
     * 5. Resume stopped queue
     * <p>
    ...
    private boolean isInPauseState() {
        return mCurrentPlayerState == PlayerMessageState.PAUSING || mCurrentPlayerState == PlayerMessageState.PAUSED;
    }
